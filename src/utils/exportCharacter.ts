...
export const exportCharacter = () => {
	const { profile, attributes, talents, combat, spellbook, karma, conditions, roll, settings } = store.getState();
	const snapshot = toPersisted({ profile, attributes, talents, combat, spellbook, karma, conditions, roll, settings });
